 ...
 * may be written. That singularity is what makes the PII rule verifiable the
 * way `requireRole` is: review greps for `person: { select:` and every hit that
 * is not this file is a bug.
 *
